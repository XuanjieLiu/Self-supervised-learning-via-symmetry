...
class BallTrainer:
    def __init__(self, config, is_train=True, seed=None):
        torch_set_seed(seed)
    ...
    def eval(self, epoch_num, iter_num, eval_loss_counter):
        ...
        for i in range(eval_iter_num):
            ...
            z_rp, mu, _ = self.model.batch_seq_encode_to_z(data)
            ...
            vae_loss = self.calc_vae_loss(data, z_rp, mu, None)[0].item()
    ...
    def train(self):
        ...
        for i in range(iter_num, self.max_iter_num):
            ...
            z_rpm, mu, _ = self.model.batch_seq_encode_to_z(data)
            ...
            vae_loss = self.calc_vae_loss(data, z_rpm, mu, None, recon_list)
    ...
    def calc_vae_loss(self, data, z_gt, mu, _, recon_list=None):
