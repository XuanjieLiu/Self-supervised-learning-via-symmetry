...
CONFIG = {
    'train_data_path': f'{data_root}/32_32_0.2_20_3_init_points_colorful_continue/',
    'latent_code_num': 3,
    't_batch_multiple': 1,
    'r_batch_multiple': 1,
    ...
    'rnn_num_layers': 1,
    'rnn_hidden_size': 256,
    'eval_data_path': f'{data_root}/32_32_0.2_20_3_init_points_colorful_continue_evalset/',
